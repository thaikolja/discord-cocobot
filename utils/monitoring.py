...
class BotMetrics:
    ...
    def record_command_duration(
        self, command_name: str, duration_seconds: float, success: bool = True
    ):
    ...
    def record_api_duration(
        self, api_name: str, duration_seconds: float, success: bool = True
    ):
...
def record_command_duration(
    command_name: str, duration_seconds: float, success: bool = True
):
    """Record command execution duration."""
