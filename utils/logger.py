...
def setup_logging(log_level: str = "INFO", log_file: str = None, max_bytes: int = 10485760, backup_count: int = 5):
    """
    ...
    try:
        ...
        print(f"Warning: Cannot write to log file {log_file}, continuing with console only")
